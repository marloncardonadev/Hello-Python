...
def is_anagrama(word_one, word_two):
    return word_one.lower() == word_two.lower()[::-1] # Se ponen las palabras en minuscula y se invierte la ultima
...
print("LA SUCESIÓN DE FIBONACCI")
...
def fibonacci():
    ...
    for index in range(0, 50):
        print(number_before)
        fibo = number_before + number_actual
